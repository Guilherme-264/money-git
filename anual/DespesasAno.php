    ...
    <div class="container mt-4">
        <table class="table table-bordered table table-dark">
            ...
            <tbody>
                ...
                ?>
                <tr>
                    <td><?php echo $linha['receptor'] ?></td>
                    <td><?php echo $linha['valor']?></td>
                    <td><?php echo $linha['descricao'] ?></td>
                    <td><?php echo date('d/m/Y', strtotime ($linha['data_pago'])) ?></td>
                ...
                <script>
                    function excluir (ID){
                        ...
                        location.href = "../LisataTransferencia/ExcluiDespesas.php?ID="+ID;     }
                </script>         
                <?php }
                ?>
            </tbody>
...
// ../ListaTransferencia/ExcluiGanhos.php?ID=" + ID;
